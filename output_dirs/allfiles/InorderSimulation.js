...
function writeSimulationInstructionsInorder(node) {
    let rightAns = inorderNodeList[counter];
    if (node == rightAns) {
        if (counter == 0)
...
learnModal.onclick = function () {
    removeModal();
    footPrint('InorderDemo.html', 'Demo', 'Inorder');
};
testModal.onclick = function () {
    removeModal();
    footPrint('InorderTest.html', 'Evaluation', 'Inorder');
};
...
//# sourceMappingURL=InorderSimulation.js.map